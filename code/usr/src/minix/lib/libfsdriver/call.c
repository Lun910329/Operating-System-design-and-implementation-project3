...
int fsdriver_iwalker(const struct fsdriver * __restrict fdp,
	const message * __restrict m_in, message * __restrict __unused m_out)
{
	printf("fsdriver_iwalker() ===>\n");
...
int fsdriver_zwalker(const struct fsdriver * __restrict fdp,
	const message * __restrict m_in, message * __restrict __unused m_out)
{
	printf("fsdriver_zwalker() ===>\n");
